from infrastructure.constants._string import MessagesConstants
...
class BadRequestSchema(BaseErrorSchema):
    errors = fields.List(
        ...
        example=[MessagesConstants.MSG_BAD_PARAMETER_INPUT_FORMAT],
    )
...
class NotFoundSchema(BaseErrorSchema):
    errors = fields.List(
        ...
        required=False,
        description=MessagesConstants.MSG_REASON_FOR_FAILED_REQUEST,
        example=[MessagesConstants.MSG_BAD_PARAMETER_INPUT_CONTENT],
    )
...
class ServerErrorSchema(BaseErrorSchema):
    errors = fields.List(
        ...
        required=False,
        description=MessagesConstants.MSG_REASON_FOR_FAILED_REQUEST,
        example=[MessagesConstants.MSG_SERVER_TIMEOUT],
    )
